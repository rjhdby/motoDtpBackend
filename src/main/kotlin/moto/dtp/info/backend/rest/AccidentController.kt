...
class AccidentController(
    ...
    ): Mono<ResponseEntity<AccidentResponse>> = mono { handle { accidentService.get(token, id).toAccidentResponse() } }
    ...
    fun create(
        ...
        mono { handle { accidentService.create(token, request).toAccidentResponse() } }
    ...
    fun update(
        ...
        mono { handle { accidentService.update(token, id, request).toAccidentResponse() } }
    ...
    fun hide(
        ...
        mono { handle { accidentService.setHidden(token, id, true).toAccidentResponse() } }
    ...
    fun show(
        ...
        mono { handle { accidentService.setHidden(token, id, false).toAccidentResponse() } }
    ...
    fun resolve(
        ...
        mono { handle { accidentService.setResolve(token, id, true).toAccidentResponse() } }
    ...
    fun reopen(
        ...
        mono { handle { accidentService.setResolve(token, id, false).toAccidentResponse() } }
    ...
    fun conflict(
        ...
        mono { handle { accidentService.setConflict(token, id, true).toAccidentResponse() } }
    ...
    fun cancelConflict(
        ...
        mono { handle { accidentService.setConflict(token, id, false).toAccidentResponse() } }
}